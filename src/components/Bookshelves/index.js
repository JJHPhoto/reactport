...
function Bookshelves() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row justify-between items-center w-11/12">
      <LazyLoadImage
        effect="blur"
        placeholderSrc={content.bookshelves.imgPlaceholder}
        src={content.bookshelves.img}
        alt="mobile view"
...
const ProjectDetail = () => {
  ...
  return (
    <div>
      ...
      >
        {content.bookshelves.projectName}
      </h1>
      <p
        className={` ${
          animated ? "" : "translate-y-10 opacity-0"
      ...
      >
        {content.bookshelves.desc}
      </p>
      <button>
        <a
          href="https://jjh-bookshelves.herokuapp.com"
          rel="noreferrer"
          target="_blank"
          className={`${
            animated ? "" : "translate-y-10 opacity-0"
